...
names(subset)<-c("Lunedì","Martedì", "Mercoledì","Giovedì", "Venerdì","Sabato","Domenica")
str(subset)
...
plot(mappa)
save(mappa, file="kohonen/mappa_giorni_settimana_sky")
...
save(mappa, file="kohonen/mappa_giorni_settimana_sky_def")
save(d1, file="kohonen/d1_giorni_settimana_def")

# load(file="kohonen/mappa_giorni_settimana_sky_def")
# load(file="kohonen/d1_giorni_settimana_def")
...
print(plot_legend(mappa, ncol=4))
