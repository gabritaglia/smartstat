...
rm(v)
save(file="sample2/cookies", cookies)


##------------------------------------------------------------------------------------
##--- PIATTAFORMA_sample2
load("sample2/piattaforma_sample2")
p<-piattaforma_sample2
p<-p[,-1]
rm(piattaforma_sample2)
...
save(pd, file="sample2/prodotti_sample22")
# load("sample2/prodotti_sample2")
