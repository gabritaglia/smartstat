...
tab2<-data.frame(visitorID=cbind(row.names(tab2)),
                 ...
                 p_visite_postlav=tab2[,5],
                 p_visite_even=tab2[,6],
                 p_visite_nigh=tab2[,7]
)
...
tab2<-data.frame(visitorID=cbind(row.names(tab2)),
		 ...
		 p_visite_postlav_wd=tab2[,9],
                 p_visite_even_wd=tab2[,11],
                 p_visite_nigh_wd=tab2[,13],
                 p_visite_prelav_we=tab2[,2],
                 p_visite_morn_we=tab2[,4],
                 p_visite_lunc_we=tab2[,6],
                 p_visite_afte_we=tab2[,8],
                 p_visite_postlav_we=tab2[,10],
                 p_visite_even_we=tab2[,12],
                 p_visite_nigh_we=tab2[,14]
)
cookies<-merge(cookies, tab2, by="visitorID", all=T)
rm(tab2)
...
#pages_ass
pages_ass<-freqParole("pages_assist")
#pages_cont_clienti
pages_cont_clienti<-freqParole("pages_cont_clienti") 
#pages_news
...
#pages_home
pages_home<-freqParole("pages_home")
#pages_nondef
pages_nondef<-freqParole("pages_nondef")
# 
# write.csv(file="output/pages_comm.csv", pages_comm, row.names=F)
# write.csv(file="output/pages_ass.csv", pages_ass, row.names=F)
# write.csv(file="output/pages_cont_clienti.csv", pages_cont_clienti, row.names=F)
...
# write.csv(file="output/pages_home.csv", pages_home, row.names=F)
# write.csv(file="output/pages_nondef.csv", pages_nondef, row.names=F)

rm(pages_comm,pages_ass, pages_cont_clienti,pages_news,pages_meteo,pages_sport, pages_intrattenimento, pages_contenuti_generico, pages_nondef, pages_home)
...
# #entry_pages_ass
# entry_pages_ass<-freqParole("entry_assist",data=pg2)
# #entry_pages_cont_clienti
# entry_pages_cont_clienti<-freqParole("entry_cont_clienti",data=pg2) 
# #entry_pages_news
...
# #entry_pages_home
# entry_pages_home<-freqParole("entry_home", data=pg2)
# #entry_pages_nondef
# entry_pages_nondef<-freqParole("entry_nondef", data=pg2)
# 
# write.csv(file="output/entry_comm.csv", entry_comm, row.names=F)
# write.csv(file="output/entry_ass.csv", entry_ass, row.names=F)
# write.csv(file="output/entry_cont_clienti.csv", entry_cont_clienti, row.names=F)
# write.csv(file="output/entry_news.csv", entry_news, row.names=F)
# write.csv(file="output/entry_meteo.csv", entry_meteo, row.names=F)
# write.csv(file="output/entry_sport.csv", entry_sport, row.names=F)
# write.csv(file="output/entry_intrattenimento.csv", entry_intrattenimento, row.names=F)
# write.csv(file="output/entry_contenuti_generico.csv", entry_contenuti_generico, row.names=F)
# write.csv(file="output/entry_home.csv", entry_home, row.names=F)
# write.csv(file="output/entry_nondef.csv", entry_nondef, row.names=F)
